...
注意：如果没有特殊指明，本文档的所有操作**均在 master137 节点上执行**，然后远程分发文件和执行命令。
...
tcp        0      0 192.168.182.137:10249   0.0.0.0:*               LISTEN      25050/kube-proxy    
tcp        0      0 192.168.182.137:10256   0.0.0.0:*               LISTEN      25050/kube-proxy 
```
...
TCP  10.254.0.1:443 rr
  -> 192.168.182.137:6443         Masq    1      0          0         
  -> 192.168.182.138:6443         Masq    1      0          0         
  -> 192.168.182.139:6443         Masq    1      0          0         
>>> 192.168.182.138
IP Virtual Server version 1.2.1 (size=4096)
Prot LocalAddress:Port Scheduler Flags
  -> RemoteAddress:Port           Forward Weight ActiveConn InActConn
