...
stream {
    upstream backend {
        ...
        server 192.168.182.137:6443        max_fails=3 fail_timeout=30s;
        server 192.168.182.138:6443        max_fails=3 fail_timeout=30s;
        server 192.168.182.139:6443        max_fails=3 fail_timeout=30s;
    }
