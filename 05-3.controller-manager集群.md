...
kube-controller-manager 使用 kubeconfig 文件访问 apiserver，该文件提供了 apiserver 地址、嵌入的 CA 证书和 kube-controller-manager 证书等信息，创建`k8s_ctrmg.sh`执行：
...
分发 kubeconfig 到所有 master 节点，创建`k8s_ctrmg_conf_dispatcher.sh`：
...
``` bash
$ curl -s --cacert /opt/k8s/work/ca.pem --cert /opt/k8s/work/admin.pem --key /opt/k8s/work/admin-key.pem https://192.168.182.137:10252/metrics |head
...
metadata:
  annotations:
    control-plane.alpha.kubernetes.io/leader: '{"holderIdentity":"master137_5a417047-dde2-4500-974a-bc854a8d500d","leaseDurationSeconds":15,"acquireTime":"2021-04-30T07:50:48Z","renewTime":"2021-04-30T07:53:15Z","leaderTransitions":1}'
  creationTimestamp: "2021-04-30T07:49:38Z"
  managedFields:
  - apiVersion: v1
    fieldsType: FieldsV1
    fieldsV1:
    ...
    operation: Update
    time: "2021-04-30T07:53:15Z"
  name: kube-controller-manager
  namespace: kube-system
  resourceVersion: "1277"
  selfLink: /api/v1/namespaces/kube-system/endpoints/kube-controller-manager
  uid: fbea6299-fe62-46aa-b18e-ea653a875a7a
```
